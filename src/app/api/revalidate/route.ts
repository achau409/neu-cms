...
/**
 * Manual cache revalidation endpoint — useful for external webhooks or debugging.
 * The collections already auto-revalidate via afterChange/afterDelete hooks,
 * but this endpoint lets you force a bust without touching the admin.
 *
 * Usage:
